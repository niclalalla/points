...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  app.extensionSettings['points'] = function () {
    return m.route.set(app.route('points'));
  };
...
var SettingsPage = /*#__PURE__*/function (_Page) {
  ...
  _proto.view = function view() {
    ...
    return m("div", {
      ...
      className: "container"
    }, this.loading ? flarum_components_LoadingIndicator__WEBPACK_IMPORTED_MODULE_2___default.a.component() : app.store.all('points/list').length ? m("table", {
      style: {
        width: '100%',
        textAlign: 'center'
      },
    ...
    }, m("th", null, "\u7528\u6237\u540D"), m("th", null, "\u7C7B\u578B"), m("th", null, "\u6263\u9664Points"), m("th", null, "\u5269\u4F59Points"), m("th", null, "\u94B1\u5305\u5730\u5740"), m("th", null, "\u63D0\u4EA4\u65F6\u95F4"), m("th", null, "\u64CD\u4F5C"))), m("tbody", null, app.store.all('points/list').length.map(function (bannedIP) {
...
/* harmony import */ var _models_Pointslist__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/Pointslist */ "./src/admin/models/Pointslist.js");
...
app.initializers.add('goaskme/points-convert', function () {
  app.store.models.points = _models_Pointslist__WEBPACK_IMPORTED_MODULE_1__["default"];
  app.store.models.users.prototype.points = flarum_Model__WEBPACK_IMPORTED_MODULE_0___default.a.hasMany('banned_ips');
...
var PointsList = /*#__PURE__*/function (_mixin) {
  ...
  var _proto = PointsList.prototype;
