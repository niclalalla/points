...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  app.routes['user.GoAskMePoints'] = {
    ...
    component: _components_addGoaskmePointsUserPage__WEBPACK_IMPORTED_MODULE_3__["default"]
  };
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_SessionDropdown__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'items', function (items) {
    ...
    items.add('settings', flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_1___default.a.component({
      icon: 'fa fa-star',
      href: app.route('user.GoAskMePoints', {
        username: user.username()
      })
    }, app.translator.trans('goaskme-points.forum.user.dropdown_label')), 99);
  }); // 缺乏登陆判断
...
/***/ "./src/forum/components/CloseModal.js":
/*!********************************************!*\
  !*** ./src/forum/components/CloseModal.js ***!
  \********************************************/
/*! exports provided: default */
...
var CloseModal = /*#__PURE__*/function (_Modal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(CloseModal, _Modal);

  function CloseModal() {
    return _Modal.apply(this, arguments) || this;
  }

  var _proto = CloseModal.prototype;
  ...
  _proto.content = function content() {
    ...
    }, m("h2", null, app.translator.trans('goaskme-points.forum.convert_gam.close_info'))));
  };
...
var RequestsList = /*#__PURE__*/function (_Component) {
  ...
  _proto.vnode = function vnode(_vnode) {
    this.loading = false;
    this.load();
  };
  ...
  _proto.view = function view() {
    ...
    return m("div", {
      ...
      return m("tr", null, m("td", {
        "class": "NotificationGrid-groupToggle"
      }, request.type == 'exchange' || request.type == 'tax_income' || request.type == 'class_income' ? m("a", {
        href: "https://shop.goaskme.app",
        target: "_blank"
      }, app.translator.trans('goaskme-points.forum.convert_gam_list.' + request.type)) : app.translator.trans('goaskme-points.forum.convert_gam_list.' + request.type)), m("td", {
        "class": "NotificationGrid-groupToggle"
      }, " ", request.amount), m("td", {
        "class": "NotificationGrid-groupToggle"
...
/* harmony import */ var _CloseModal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./CloseModal */ "./src/forum/components/CloseModal.js");
  ...
  _proto.actionItems = function actionItems() {
    ...
    items.add('start_convert_gam', flarum_components_Button__WEBPACK_IMPORTED_MODULE_3___default.a.component({
      ...
      onclick: function onclick() {
        app.modal.show(_CloseModal__WEBPACK_IMPORTED_MODULE_8__["default"]); // app.modal.show(new RequestModal())
      }
...
app.initializers.add('goaskme-flarum-points', function () {
  ...
  Object(_addGoaskmePointsPage__WEBPACK_IMPORTED_MODULE_2__["default"])(); //下拉按钮

  Object(_addGoaskmePointsSessionDropdown__WEBPACK_IMPORTED_MODULE_3__["default"])(); //荣誉爆炸值
